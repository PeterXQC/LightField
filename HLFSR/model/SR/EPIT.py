...
# 增加卷积层，将1x1x1280x1280变为1x1x256x256
        y_out_split = LFsplit(y, 5)
        out_new = self.featureFusion(y_out_split)  # sen_add: 增加3D卷积，实现多角度特征融合
        return out_new
...
# tmp = y_out_split[0,0,:,:].cpu().detach().numpy()
# plt.imshow(tmp)
# plt.show()
