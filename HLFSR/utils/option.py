...
parser.add_argument('--path_for_train', type=str, default='D:\DATASET\DatasetWithNoise\train')
parser.add_argument('--path_for_test', type=str, default='D:\DATASET\DatasetWithNoise\test')
...
parser.add_argument('--epoch', default=351, type=int, help='Epoch to run [default: 50]')
