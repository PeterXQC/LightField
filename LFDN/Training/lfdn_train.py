...
parser.add_argument("--sampleNum", type=int, default=700, help="The number of LF in training set")
parser.add_argument("--patchSize", type=int, default=8, help="The size of croped LF patch")
parser.add_argument("--channelNum", type=int, default=1, help="The number of input channels")
parser.add_argument("--epochNum", type=int, default=7000, help="The number of epoches")
parser.add_argument("--summaryPath", type=str, default='./', help="Path for saving training log ")
parser.add_argument("--dataPath", type=str, default='D:\XuQichen\LightField\LFDN\LFData\\train_data.mat', help="Path for loading training data ")
...
if __name__ == '__main__':
    ...
    SetupSeed(1)
    savePath = 'D:\XuQichen\LightField\LFDN\model\\lfdn_SASOnly_Res{}.pth'.format(opt.sigma)
